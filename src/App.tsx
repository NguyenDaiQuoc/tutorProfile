    ...
    <div className="min-h-screen bg-[#FDFCF8] dark:bg-[#0F172A] text-[#1A1A1A] dark:text-[#F8FAFC] font-sans selection:bg-[#E6F0FF] dark:selection:bg-blue-900/30 overflow-x-hidden transition-colors duration-300">
      ...
      <main className="pt-24">
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Gia sư & Kỹ sư Phần mềm
            </motion.span>
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-6 tracking-tight">
              Chào phụ huynh, <br />
              tôi là <span className="text-blue-600 dark:text-blue-400">Quốc.</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-lg leading-relaxed">
              Gia sư Toán tâm huyết cho học sinh K-8 và Kỹ sư phần mềm tương lai từ Đại học Sài Gòn. Tôi kết hợp tư duy logic lập trình vào việc giảng dạy Toán học.
            </p>
        ...
        <section id="about" className="bg-white dark:bg-slate-900/50 py-24 border-y border-gray-50 dark:border-slate-800 transition-colors">
          <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-bold tracking-tight">Về tôi</h2>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                Tôi hiện là sinh viên năm 3 ngành Kỹ thuật Phần mềm tại Đại học Sài Gòn. Với nền tảng kiến thức vững chắc về Toán học và Lập trình, tôi đã có hơn 2 năm kinh nghiệm dạy kèm cho học sinh từ mầm non đến lớp 8.
              </p>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                Phương pháp giảng dạy của tôi tập trung vào việc khơi gợi sự tò mò, rèn luyện tư duy phản biện và giải quyết vấn đề thay vì chỉ học thuộc lòng công thức.
              </p>
              <motion.div 
              ...
              >
                ...
                <div>
                  <p className="font-bold text-base">Đại học Sài Gòn</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wide">Kỹ sư Phần mềm (2022 — 2027)</p>
                </div>
              </motion.div>
            </motion.div>
        ...
        <section id="skills" className="py-24 max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl font-bold mb-4 tracking-tight">Kỹ năng giảng dạy & Công nghệ</h2>
            <p className="text-gray-500 dark:text-gray-400 text-lg">Sự kết hợp giữa tư duy Toán học và kỹ năng lập trình hiện đại.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            >
              <div className="flex items-center gap-4 mb-10">
                ...
                <h3 className="font-bold text-2xl tracking-tight">Giảng dạy & Tư duy</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-4 mb-10">
                ...
                <h3 className="font-bold text-2xl tracking-tight">Công nghệ & Lập trình</h3>
              </div>
              <div className="space-y-6">
                {[
                  { name: "C/C++", level: 85 },
        ...
        <section id="awards" className="bg-[#1A1A1A] dark:bg-slate-950 text-white py-32 relative overflow-hidden transition-colors">
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            >
              <div>
                <h2 className="text-4xl font-bold mb-4 tracking-tight">Giải thưởng & Thành tích</h2>
                <p className="text-gray-400 text-lg">Minh chứng cho sự nỗ lực và khả năng học thuật xuất sắc.</p>
              </div>
              <motion.div
        ...
        <section id="experience" className="py-32 max-w-6xl mx-auto px-6">
          ...
          <div className="relative border-l-2 border-gray-100 pl-12 ml-4 space-y-20">
            <motion.div 
              variants={reveal}
              initial="initial"
              whileInView="whileInView"
            ...
            >
              <motion.div 
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                className="absolute -left-[57px] top-0 w-6 h-6 rounded-full bg-blue-600 border-4 border-white shadow-md shadow-blue-500/20"
              />
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-start gap-2">
                  <div>
                    <h3 className="text-2xl font-bold tracking-tight">Gia sư Toán (Math Tutor)</h3>
                    <p className="text-blue-600 font-bold text-lg">Tự do</p>
                  </div>
                  <span className="text-sm text-gray-400 font-bold bg-gray-50 px-4 py-1.5 rounded-full border border-gray-100 uppercase tracking-wider">2022 — Hiện tại</span>
                </div>
                <ul className="space-y-5 text-gray-600 dark:text-gray-400 text-lg">
                  {[
                    "Dạy kèm cho học sinh từ mầm non đến lớp 8, tập trung vào củng cố kiến thức căn bản và nâng cao kỹ năng giải toán.",
                    "Cải thiện tư duy logic và phương pháp học tập hiệu quả cho học sinh.",
                    ...
                    >
                      ...
                      >
                        <Star size={18} className="text-blue-500 dark:text-blue-400 shrink-0" />
                      </motion.div>
        ...
        <section id="projects" className="bg-gray-50 dark:bg-slate-900/30 py-32 transition-colors">
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              <div>
                <h2 className="text-4xl font-bold mb-4 tracking-tight">Dự án công nghệ</h2>
                <p className="text-gray-500 dark:text-gray-400 text-lg">Các ứng dụng thực tế thể hiện kỹ năng lập trình và tư duy hệ thống.</p>
              </div>
        ...
        <section id="testimonials" className="py-32 transition-colors">
          <div className="max-w-6xl mx-auto px-6">
            <motion.div 
              ...
              className="text-center mb-20"
            >
              <h2 className="text-4xl font-bold mb-4 tracking-tight">Phụ huynh nói gì?</h2>
              <p className="text-gray-500 dark:text-gray-400 text-lg max-w-2xl mx-auto">Sự tin tưởng của phụ huynh là động lực lớn nhất để tôi không ngừng hoàn thiện phương pháp giảng dạy.</p>
            </motion.div>
        ...
        <section className="py-32 max-w-4xl mx-auto px-6 text-center relative">
          ...
          >
            <h2 className="text-5xl font-bold tracking-tight">Bạn đang tìm gia sư cho con?</h2>
            <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Hãy liên hệ với tôi để trao đổi về lộ trình học tập phù hợp nhất cho bé. Tôi luôn sẵn sàng lắng nghe và chia sẻ.
            </p>
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center pt-6">
              ...
              >
                Gửi Email <Mail size={24} />
              </motion.button>
              <motion.div 
                whileHover={{ x: 5 }}
                className="text-base text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest"
              >
                Hoặc kết nối qua <a href="https://linkedin.com/in/NguyenDaiQuoc" className="text-blue-600 dark:text-blue-400 underline decoration-2 underline-offset-4">LinkedIn</a>
              </motion.div>
            </div>
          </motion.div>
        </section>
      ...
      <footer className="py-16 border-t border-gray-100 dark:border-slate-800 text-center text-sm text-gray-400 bg-white dark:bg-slate-900 transition-colors">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            © 2026 Nguyễn Đại Quốc. Thiết kế dựa trên Portfolio Template.
          </motion.p>
        </div>
      </footer>
            ...
            >
              <div className="p-8 md:p-10">
                <div className="flex justify-between items-center mb-8">
                  <div>
                    <h2 className="text-3xl font-bold tracking-tight">Gửi tin nhắn</h2>
                    <p className="text-gray-500 dark:text-gray-400">Tôi sẽ phản hồi bạn sớm nhất có thể.</p>
                  </div>
                  <button 
                    onClick={() => setIsContactModalOpen(false)}
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Chủ đề</label>
                    <input 
                      required
                      type="text" 
                      placeholder="Gia sư Toán lớp 5"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Nội dung</label>
                    <textarea 
                      required
                      rows={4}
                      placeholder="Chào Quốc, tôi muốn tìm hiểu về..."
        ...
        {showSuccess && (
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            >
              ...
              <h2 className="text-4xl font-bold tracking-tight">Cảm ơn đã tin tưởng!</h2>
              <p className="text-blue-100 text-lg leading-relaxed">
                Tin nhắn của bạn đã được gửi thành công. Tôi sẽ liên hệ lại với bạn qua email sớm nhất có thể.
              </p>
              <motion.button 
